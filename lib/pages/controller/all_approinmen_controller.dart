...
import '../model/all_apmt_response_model.dart';

class AllApmtController   extends GetxController with StateMixin<bool>{
...
DioClient dioClient=DioClient(BASE_URL, Dio());
  ...
  void onInit() {
     ...
     pagingController.addPageRequestListener((pageKey) {
      AllApmtFetchPage(pageKey);
    });
    // TODO: implement onInit
    super.onInit();
  }

      Future<void> AllApmtFetchPage(int pageKey) async {
    debugPrint("stater notification");
    try {
      final res =
          await dioClient.get("/appointments?page=$pageKey&limit=$_pageSize");
