...
import 'package:appointments_app/pages/controller/rejecte_list_controller_page.dart';
...
class RejectPageHistory extends StatelessWidget {
    RejectPageHistory({
    super.key,
   
  });
    final controller=Get.put(RejectPageController());
