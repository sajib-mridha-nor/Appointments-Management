...
class TestM extends StatefulWidget {
  const TestM({super.key});

  @override
  State<TestM> createState() => _TestMState();
}

class _TestMState extends State<TestM> {
...
void request() async {
  ...
  final String? url="https://api.weatherapi.com/v1/forecast.json?key=86375b668a3b424bbe170545232007&q=07112&days=7";
...
class dioClient{
  ...
  final String url="https://api.weatherapi.com/v1/forecast.json?key=86375b668a3b424bbe170545232007&q=07112&days=7";
  final String url1="https://api.weatherapi.com/v1/forecast.json";
...
// Position position = await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high);
  ...
  try {
  // 404
 var res= await dio.get('$url1',
  
  queryParameters: {"key":"86375b668a3b424bbe170545232007","q":"Dhaka","days":7}
  
  );

  print("$res");
 var w= weather.fromJson(res.data);
 print(w.current?.feelslikeC);
